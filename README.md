...
# In macOS/Linux/gitbash, you want to run the following command to activate the virtual environment
source venv/bin/activate

# In Windows Powershell use this command to activate the virtual environment
.\venv\Scripts\Activate.ps1

# windows powershell only: if you get an "execution policy" error, run this first and then try again:
Set-ExecutionPolicy -Scope CurrentUser -ExecutionPolicy RemoteSigned

# Note: to deactivate the venv, run the `deactivate` command from within the venv
